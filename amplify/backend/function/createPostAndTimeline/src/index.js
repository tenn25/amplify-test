...
var apiGraphqlapiGraphQLAPIEndpointOutput = process.env.API_BOYAKIL_GRAPHQLAPIENDPOINTOUTPUT
...
exports.handler = async (event, context, callback) => {
    ...
    if ('AWS_EXECUTION_ENV' in process.env && process.env.AWS_EXECUTION_ENV.startsWith('AWS_Lambda_')) {
        ...
        // for local mock
        env = {
            API_BOYAKI_GRAPHQLAPIENDPOINTOUTPUT: 'http://localhost:20002/graphql',
            REGION: 'us-east-1',
        }
        graphql_auth = {
            type: "AWS_IAM",
